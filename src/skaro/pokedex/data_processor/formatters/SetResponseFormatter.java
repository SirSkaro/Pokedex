...
public class SetResponseFormatter implements ResponseFormatter, IServiceConsumer
{
	private IServiceManager services;
	
	public SetResponseFormatter(IServiceManager services) throws ServiceConsumerException
	{
