...
public class ItemResponseFormatter implements ResponseFormatter, PokedexServiceConsumer
{
	private PokedexServiceManager services;
	
	public ItemResponseFormatter(PokedexServiceManager services) throws ServiceConsumerException
	{
